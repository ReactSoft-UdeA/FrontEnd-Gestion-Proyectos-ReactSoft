        ...
        <ProjectQueryContext.Provider value={{ queryData }}>
          <div className="p-10 flex flex-col">
            <div className="flex w-full items-center justify-center">
              <h1 className="text-7xl text-gray-900 text-white font-medium tracking-tight">
                Lista de Proyectos con Objetivos
              </h1>
            </div>
            ...
            <PrivateComponent roleList={["LIDER"]}>
              <div className="my-2 self-end">
                <button className="btn btn-outline-success">
                  <Link
                    className="bg-blue text-gray-900 hover:text-white"
                    to="/proyectos/nuevo"
                  >
                    Crear Proyecto
                  </Link>
...
const AccordionProyecto = ({ proyecto }) => {
  ...
  return (
    <>
      <AccordionStyled>
        <AccordionSummaryStyled
          expandIcon={<i className="text-blue-600 fas fa-hand-point-down" />}
        >
          <div className="justify-center">
            <div className="font-bold text-black-100">{proyecto.nombre}</div>
            <div className="flex text-black-100">
              Estado Proyecto: .
              <div className="font-bold ">{proyecto.estado}</div>
            </div>
          </div>
        </AccordionSummaryStyled>
        <AccordionDetailsStyled>
          <div className="font-sans font-bold">
            Este proyecto se encuentra liderado Por:{" "}
          </div>
...
const Objetivo = ({ index, _id, idProyecto, tipo, descripcion }) => {
  ...
  if (eliminarLoading)
    return <ReactLoading type="spin" height={50} width={50} />;
              ...
              <PrivateComponent roleList={["LIDER"]}>
                <div className="">
                  <i
                    ...
                    className="far fa-edit mx-2 hover:text-green-600 cursor-pointer"
                  />
                  <i
                    onClick={ejecutarEliminacion}
                    className="fas fa-minus-circle mx-2 hover:text-red-600 cursor-pointer"
                  />
                </div>
                <Dialog
                  open={showEditDialog}
