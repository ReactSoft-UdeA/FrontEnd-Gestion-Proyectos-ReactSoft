    ...
    <div class="bg-gradient-to-r from-blue-500 to-green-500 rounded-lg px-6 py-8 ring-1 ring-gray-900/5 shadow-xl">
      <div className="p-10 flex flex-col">
        <div className="flex w-full items-center justify-center">
          <h1 className="text-9xl text-white text-white font-medium tracking-tight">
            Iniciar Sesión
          </h1>
        </div>
        <span className="text 3xl text-bold text-white text-center">
          !Bienvenido/a!
        </span>
        <form
        ...
        <span className="text-1xl text-bold text-white-300">
