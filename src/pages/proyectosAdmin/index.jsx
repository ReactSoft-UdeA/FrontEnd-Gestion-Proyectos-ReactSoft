  ...
  return (
    ...
    <div>
      <PrivateRoute roleList={["ADMINISTRADOR"]}>
        <h1 className="text-center text-7xl text-gray-900 text-white font-medium tracking-tight">
            ...
            <div className= 'container pt-10'>
                <table className="table table-success table-striped table-hover align-middle table-bordered ">
                    <thead className="table-primary ">
                        ...
                        <th scope="col" className="text-center">Fase</th>
                                ...
                                return (
                                    <tr key={p._id}>
                                        {/* <th scope="row" className="text-center">{p._id.slice(20)}</th> */}
                                            ...
                                            <td className="text-center">{p.fechaInicio}</td>
                                            <td className="text-center">{p.fechaFin}</td>
                                            <td className="text-center">{p.estado}</td>
                                            <td className="text-center">{p.fase}</td>
                                            <td ><Link to ={`/proyectosAdmin/editar/${p._id}`} ><i className='fas fa-pen input-group justify-content-around '></i></Link></td>
                                    </tr>
                                );
