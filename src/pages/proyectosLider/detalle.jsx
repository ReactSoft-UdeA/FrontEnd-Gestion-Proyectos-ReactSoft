...
const ProyectosDetalle = () => {
  ...
  const [editarProyecto, { data: mutationData3 }] = useMutation(
    EDITAR_PROYECTO_LIDER
  );

  // agregar observación
  const [editarAvanceObs, { data: mutationData4 }] = useMutation(
    ADD_OBSERVACION_AVANCE
  );
  ...
  */
  ...
  const [
    aprobarInscripcion,
    { data: aprobarData, loading: aprobarLoading, error: aprobarError },
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3 col-lg-10 m-3">
                  ...
                  <input type="text" class="form-control" id="idAvanceInput" />
                </div>
              </div>
              <div class="modal-footer">
                ...
                <button
                  type="button"
                  data-bs-dismiss="modal"
                  onClick={guardarObservacionAvance}
                    ...
                    >
                      ...
                      <div class="mb-3 col-lg-3 m-3">
                        ...
                        <input
                          ...
                          name="presupuesto"
                          defaultValue={
                            queryData2.ProyectosPorId[0].presupuesto
                          }
                          disabled
                        />
                      </div>
                      ...
                      <div class="mb-3 col-lg-3 m-3">
                        <button
                          type="button"
                          id="BtnEditar"
                          onClick={habilitarEdicionProyecto}
                          class="btn btn-primary"
                        >
                          Editar
                        </button>
                ...
                >
                  <div class="accordion-body">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        {queryData2 &&
                          queryData2.ProyectosPorId[0].inscripciones.map(
                            (u) => {
                              return (
                                <tr key={u._id}>
